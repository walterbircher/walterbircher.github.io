(function () {
  ...
  Object.assign(catalog.text, {
    de: normalizeRecord({
      ...
      "There are several genes that cause EDMD. Each gene is classified as a specific subtype of EDMD.": "Es gibt mehrere Gene, die EDMD verursachen. Jedes Gen wird als spezifischer EDMD-Subtyp eingestuft.",
      "The following table shows the seven EDMD subtypes and their associated gene, protein, and inheritance pattern.": "Die folgende Tabelle zeigt die sieben EDMD-Subtypen und das jeweils zugehörige Gen, Protein und Vererbungsmuster.",
      "Less frequently associated EDMD genes include TOR1AIP1, SUN1, SUN2 and TTNN.": "Seltener assoziierte EDMD-Gene sind TOR1AIP1, SUN1, SUN2 und TTNN.",
      "Subtype": "Subtyp",
      "Gene": "Gen",
      "Protein": "Protein",
      "Inheritance Pattern": "Vererbungsmuster",
    ...
    it: normalizeRecord({
      ...
      "There are several genes that cause EDMD. Each gene is classified as a specific subtype of EDMD.": "Esistono diversi geni che causano l'EDMD. Ogni gene è classificato come un sottotipo specifico di EDMD.",
      "The following table shows the seven EDMD subtypes and their associated gene, protein, and inheritance pattern.": "La tabella seguente mostra i sette sottotipi di EDMD e il relativo gene, proteina e modello di ereditarietà.",
      "Less frequently associated EDMD genes include TOR1AIP1, SUN1, SUN2 and TTNN.": "I geni EDMD associati meno frequentemente includono TOR1AIP1, SUN1, SUN2 e TTNN.",
      "Subtype": "Sottotipo",
      "Gene": "Gene",
      "Protein": "Proteina",
      "Inheritance Pattern": "Schema di ereditarietà",
    ...
    zh: normalizeRecord({
      ...
      "There are several genes that cause EDMD. Each gene is classified as a specific subtype of EDMD.": "有多个基因可导致 EDMD。每个基因都归类为 EDMD 的一个特定亚型。",
      "The following table shows the seven EDMD subtypes and their associated gene, protein, and inheritance pattern.": "下表列出了 EDMD 的七种亚型及其对应的基因、蛋白质和遗传方式。",
      "Less frequently associated EDMD genes include TOR1AIP1, SUN1, SUN2 and TTNN.": "较少见的 EDMD 相关基因包括 TOR1AIP1、SUN1、SUN2 和 TTNN。",
      "Subtype": "亚型",
      "Gene": "基因",
      "Protein": "蛋白质",
      "Inheritance Pattern": "遗传方式",
    ...
    ja: normalizeRecord({
      ...
      "There are several genes that cause EDMD. Each gene is classified as a specific subtype of EDMD.": "EDMD の原因となる遺伝子は複数あります。各遺伝子は EDMD の特定のサブタイプに分類されます。",
      "The following table shows the seven EDMD subtypes and their associated gene, protein, and inheritance pattern.": "次の表は、EDMD の 7 つのサブタイプと、それぞれの遺伝子、タンパク質、遺伝形式を示しています。",
      "Less frequently associated EDMD genes include TOR1AIP1, SUN1, SUN2 and TTNN.": "比較的まれに関連する EDMD 遺伝子には TOR1AIP1、SUN1、SUN2、TTNN があります。",
      "Subtype": "サブタイプ",
      "Gene": "遺伝子",
      "Protein": "タンパク質",
      "Inheritance Pattern": "遺伝形式",
      "There are several genes that cause EDMD. Each gene is classified as a specific subtype of EDMD.": "EDMD の原因となる遺伝子は複数あります。各遺伝子は EDMD の特定のサブタイプに分類されます。",
      "The following table shows the seven EDMD subtypes and their associated gene, protein, and inheritance pattern.": "次の表は、EDMD の 7 つのサブタイプと、それぞれの遺伝子、タンパク質、遺伝形式を示しています。",
      "Less frequently associated EDMD genes include TOR1AIP1, SUN1, SUN2 and TTNN.": "比較的まれに関連する EDMD 遺伝子には TOR1AIP1、SUN1、SUN2、TTNN があります。",
      "Subtype": "サブタイプ",
    ...
    ko: normalizeRecord({
      ...
      "There are several genes that cause EDMD. Each gene is classified as a specific subtype of EDMD.": "EDMD를 유발하는 여러 유전자가 있습니다. 각 유전자는 EDMD의 특정 아형으로 분류됩니다.",
      "The following table shows the seven EDMD subtypes and their associated gene, protein, and inheritance pattern.": "다음 표는 EDMD의 7가지 아형과 관련 유전자, 단백질, 유전 양식을 보여 줍니다.",
      "Less frequently associated EDMD genes include TOR1AIP1, SUN1, SUN2 and TTNN.": "덜 흔하게 연관되는 EDMD 유전자로는 TOR1AIP1, SUN1, SUN2, TTNN이 있습니다.",
      "Subtype": "아형",
      "Gene": "유전자",
      "Protein": "단백질",
      "Inheritance Pattern": "유전 양식",
